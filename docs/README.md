...
Historical phase files are retained as implementation records. Their older filename references describe the layout that existed when each phase was completed; current paths are defined by the architecture document.
