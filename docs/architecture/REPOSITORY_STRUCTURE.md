...
| Visual effects | `vfx/` | Presentation-only cast sequencing, effect lifecycle, damage-type visual identities, rendering, particles, sprites, and persistent visuals |
