...
export const DEFAULT_FEAT_RULES = Object.freeze([
  ...
  rule(
    ...
    {
      prerequisites: [{ type: "level", minimum: 4 }, { type: "feat", featIds: ["scion-of-the-outer-planes"] }],
      effects: [abilityChoice("ability", MENTAL_ABILITIES), { type: "restChoiceResistance", choiceId: "default-resistance", damageTypes: ["acid", "cold", "fire"], rest: "longRest" }, custom("portal-cracker", "Sense portals within 30 feet and treat a portal's normal reuse wait as one round for you.")],
  ...
  rule(
    ...
    "Choose one outer plane. Its influence grants a damage resistance and one cantrip, using Intelligence, Wisdom, or Charisma.",
    {
      ...
      effects: [{ type: "planarScion", choiceId: "outer-plane", abilityChoiceId: "spellcasting-ability" }],
      choices: [choice("outer-plane", "Outer plane", "option", ["Chaotic Outer Plane", "Evil Outer Plane", "Good Outer Plane", "Lawful Outer Plane", "The Outlands"]), choice("spellcasting-ability", "Spellcasting ability", "ability", MENTAL_ABILITIES)],
