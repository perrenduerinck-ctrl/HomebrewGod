...
export const SWORD_SLASH_ANIMATION = Object.freeze({
  id: "sword_slash_01", name: "Sword slash", category: "Sword", tags: ["melee", "weapon", "slash"],
...
export const BUILTIN_ANIMATIONS = Object.freeze([
  ...
  { id: "fireball_explosion_01", name: "Fireball explosion", category: "Fire", tags: ["magic", "spell", "impact"],
  ...
  { id: "healing_burst_01", name: "Healing burst", category: "Healing", tags: ["magic", "buff"],
    sprite: healing.src, grid: { columns: 5, rows: 5 }, frameCount: 25, fps: 20, atlas: healing.atlas },
  { id: "cold_burst_01", name: "Cold burst", category: "Cold", tags: ["magic", "impact"],
    sprite: "./assets/vfx/modern6x6/cold-cast-6x6.png", grid: { columns: 6, rows: 6 }, frameCount: 36, fps: 24 },
  { id: "fire_legacy_4x4", name: "Fire impact (classic)", category: "Fire", tags: ["magic", "impact", "legacy"],
    sprite: "./assets/vfx/fire/fire-impact-spritesheet.png", grid: { columns: 4, rows: 4 }, frameCount: 16, fps: 18, blendMode: "screen" },
  { id: "radiant_spear_01", name: "Radiant spear (single frame)", category: "Spear", tags: ["weapon", "projectile"],
